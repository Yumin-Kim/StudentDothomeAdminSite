...
<?php
$connection =  mysqli_connect('localhost', 'root', 'multi2021', 'portfolio');
...
if($count){
    ...
    $speechLink = $row['speech_link'];   
    $imagesFormat = $row['images_format'];   
    $description=$row['description']; 
    $name = $row['name'];   
    $email = $row['email'];   
}
$strTok =explode(',' , $imagesFormat);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <h3>프로필 이미지</h3>
    <img src="./studentImages/<?php echo $currentStudentCode ?>_<?php echo $strTok[0]?>">
    <h3>브로슈어 이미지</h3>
